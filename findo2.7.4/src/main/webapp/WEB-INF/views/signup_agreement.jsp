...
<body>
	<div class="wrapper_signup_agreement_form">
		<div class="signup_agreement_form">
			<form method="get" action="/signup" id="signup_agreement_form">
				
				<div>
					<img src="/images/logo_black.png" style="width:300px; height:100px;"/>
				</div>
				<h2>회원가입</h2>
				<div>
				...
				<div>
					<input type="checkbox" name="check1" id="check1"> 핀도 이용약관 동의(필수)
				</div>
				<textarea rows="10" cols="35" style="overflow-y: scroll;">제1조(목적) 이 약관은 업체 회사(전자상거래 사업자)가 운영하는 업체 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.
...
제24조(재판권 및 준거법)
  ...
  ② “몰”과 이용자 간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
				...
				<div>
					<input type="checkbox" name="check2" id="check2"> 개인정보 수집 및 이용에 대한 안내(필수)
				</div>
				<textarea rows="10" cols="35" style="overflow-y: scroll;">개인정보처리방침
...
2) 시행일자 : 2018년 05월 01일 </textarea>
				<div>
					<input type="checkbox" name="check3" id="check3"> 위치정보 이용약관
					동의(선택)
				</div>
				<textarea rows="10" cols="35" style="overflow-y: scroll;">제 1조 (목적)
이 약관은 핀도 주식회사(이하 “회사”)가 제공하는 위치정보서비스를 이용하는데 필요한 제반 사항을 규정함을 목적으로 합니다.

제 2조 (용어의 정의)
본 약관에서 사용하는 용어의 정의는 다음 각 호와 같으며, 본 이용약관에 규정되지 않은 용어는 서비스 관련 안내자료와 사업자료 등에서 회사가 일반적으로 사용하는 의미로 해석됩니다.

1. “위치정보서비스”(이하 “서비스”)란 회사가 개인위치정보주체의 위치정보를 수집하여 위치기반서비스사업자인 고객(이하 “이용자”)에게 제공하는 서비스를 말합니다.
2. “이용자”란 자신이 제공하는 위치기반서비스를 운영하기 위하여 회사로부터 개인위치정보주체의 위치정보를 제공받는 자를 말합니다.
3. “위치기반서비스사업자”란 위치정보를 이용한 서비스를 제공하는 자를 말합니다.
4. “위치정보시스템”은 위치정보사업과 위치기반서비스사업을 위하여 정보통신망법 제2조 제1항 제1호의 규정에 따라 정보통신망을 통하여 위치정보를 수집•분석•저장•이용•제공할 수 있도록 서로 유기적으로 연계된 컴퓨터의 하드웨어, 소프트웨어, 데이터베이스 및 인적 자원의 결합체를 말합니다.
5. “개인위치정보주체”란 개인위치정보로 식별되는 자로서, 이용자의 위치기반서비스를 이용하는 자를 말합니다. 만일 위치기반서비스를 이용하는 자가 법인이나 단체일 때에는 그 법인이나 단체의 임직원, 피용자, 대리인 등으로서 위치기반서비스를 직접 이용하는 자연인과 그 법인 및 단체와 계약 등을 체결하고 위치기반서비스를 직접 이용하는 자연인을 말합니다.
제 3조 (이용약관의 효력 및 변경)
...
③ 회사가 약관을 개정할 경우에는 기존약관과 개정약관 및 개정약관의 적용일자와 개정사유를 명시하여 기존약관과 함께 그 적용일자 7일 전부터 적용일 이후 상당한 기간 동안 공지만을 하고, 개정 내용이 이용자 또는 개인위치정보주체에게 불리한 경우에는 그 적용일자 30일 전부터 적용일 이후 상당한 기간 동안 각각 이를 서비스 홈페이지에 게시하거나 전자적 형태(전자우편, SMS 등)로 약관 개정 사실을 발송하여 고지합니다.
④ 회사가 전항에 따라 이용자 또는 개인위치정보주체에게 통지하면서 공지 또는 공지∙고지일로부터 개정약관 시행일 7일 후까지 거부의사를 표시하지 아니하면 이용약관에 승인한 것으로 봅니다. 만일 이용자 또는 개인위치정보주체가 개정약관에 동의하지 않을 경우 서비스 이용을 중단하고 이용을 해지할 수 있습니다.
제 4조 (약관 외 준칙)
이 약관에 명시되지 않은 사항은 위치정보의 보호 및 이용 등에 관한 법률, 정보통신망 이용촉진 및 정보보호 등에 관한 법률, 전기통신기본법, 전기통신사업법 등 관계법령과 회사가 별도로 정한 세부이용지침 등의 규정을 따릅니다.

제 5조 (서비스의 가입)
① 이용자가 서비스를 이용하려면 본 약관에 동의해야 하며, 이 때 회사가 별도로 정한 가입요건(가입신청서 등)이 있으면 해당 요건을 갖추어야 합니다.
② 본 조 제1항에 따른 서비스 가입신청이 있을 때 회사가 별도 승인절차를 거쳐 해당 가입 신청을 승인하면 서비스 가입이 이루어집니다. 단, 다음 각 호의 사유가 발생하면 회사는 승인을 거절할 수 있습니다.
...
① 회사는 특정 위치에 설치된 RFID전용단말기에 개인위치정보주체가 Tagging하는 방법으로 위치정보를 수집하며, 회사와 제휴한 위치기반서비스사업자에게 제공합니다.
② 전항에서 정한 개인위치정보의 수집방법이 변경될 때에는 본 약관을 개정하고 개정에 따른 사전 공지를 제3조 제3항에 따라 진행합니다.
제 7조 (서비스의 이용요금)
① 회사가 제공하는 서비스는 기본적으로 무료입니다. 단, 별도의 유료 서비스의 경우 해당 서비스에 명시된 요금을 지불하여야 사용 가능하며, 요금을 지정한 날짜까지 납부하지 않으면 사전 약정된 가산금이 부과될 수 있습니다.
...
④ 이용자의 개인정보도용 및 결제 사기로 인한 환불요청 또는 결제자의 개인정보 요구는 법률이 정한 경우 외에는 거절될 수 있습니다.
⑤ 무선 서비스 이용 시 발생하는 데이터 통신료는 별도이며 가입한 각 이동통신사의 정책에 따릅니다.
⑥ MMS 등으로 게시물을 등록할 경우 발생하는 요금은 이동통신사의 정책에 따릅니다.
제 8조 (서비스 내용 변경 통지 등)
① 회사가 서비스 내용을 변경하거나 종료하는 경우 회사는 이용자의 등록된 전자우편 주소 또는 통신 단말 장치 등을 통하여 서비스내용의 변경 사항 또는 종료를 통지할 수 있습니다.
② 제 ①의항의 경우 불특정 다수인을 상대로 통지를 함에 있어서는 웹사이트 등 기타 회사의 공지 사항을 통하여 통지할 수 있습니다.
제 9조 (서비스 이용의 제한 및 중지)
① 회사는 아래 각 호의 경우에는 이용자 또는 개인위치정보주체의 서비스 이용을 제한하거나 중지시킬 수 있습니다.
1) 서비스를 이용하여 법령, 공공질서, 미풍양속 등을 거스르는 위치기반서비스를 제공하는 경우
2) 회사의 서비스 운영을 고의 또는 중과실로 방해하는 경우
3) 위치정보시스템에 오류, 훼손을 가져오는 행위를 하거나 위치정보시스템의 오류, 오작동을 악용하는 행위를 하는 경우
4) 관계 법령이나 관계 기관의 명령, 지시, 지도, 권고, 법원의 판결 등으로 서비스 제공 또는 본 약관의 이행이 현저히 어려운 경우
5) 서비스 이용요금을 기간 내 납부하지 않거나 기타 본 약관상의 의무를 이행하지 않아 회사가 그 시정을 요구하였음에도 30일 이내에 시정하지 않는 경우
6) 이용자가 부도, 워크아웃, 파산신청, 회생절차 개시신청 등이 발생한 경우
7) 이용자와 회사 사이에 합의로 정한 서비스 이용 제한 또는 해지 사유가 발생한 경우
8) 서비스용 설비 점검, 보수 또는 공사로 부득이한 경우
9) 전기통신사업법에 규정된 기간통신사업자가 전기통신 서비스를 중지했을 경우
10) 국가비상사태, 서비스 설비의 장애 또는 서비스 이용의 폭주 등으로 서비스 이용에 지장이 있는 경우
11) 기타 합리적으로 볼 때 본 약관의 원활한 실현을 현저히 어렵게 하는 사유가 발생한 경우
② 회사는 전항의 규정에 의하여 서비스의 이용을 제한하거나 중지한 때에는 그 사유 및 제한기간 등을 이용자 또는 개인위치정보주체에게 알려야 합니다.
제 10조 (개인위치정보의 이용 또는 제공)
① 회사가 개인위치정보를 이용하여 서비스를 제공하고자 할 때에는 해당 내용을 미리 이용약관에 밝힌 후 개인위치정보주체의 동의를 얻어 개인위치정보를 수집•이용•제공할 수 있습니다.
② 회사는 개인위치정보주체의 동의를 얻기 위해 이용자에게 협조를 구할 수 있으며, 이용자는 이와 같은 협조 요청을 성실히 이행할 의무가 있습니다.
③ 이용자는 전 항에 따라 개인위치정보 수집에 대한 개인위치정보주체의 동의 절차를 협조할 때 위치정보법이 규정하는 수집 절차를 준수해야 합니다.
제 11조 (개인위치정보 수집, 이용, 제공사실 확인자료의 보유)
① 회사는 위치정보법 제16조 제2항에 근거하여 위치정보 수집, 이용, 제공사실 확인자료를 위치정보시스템에 자동으로 기록하는 방법으로 6개월 이상 보존합니다.
② 이용자 또는 개인위치정보주체가 개인위치정보 수집•이용•제공 동의의 전부 또는 일부를 철회하면 회사는 수집된 위치정보 수집, 이용, 제공 사실 확인자료(동의의 일부를 철회하는 경우에는 철회하는 부분의 위치정보 이용•제공사실 확인자료에 한합니다)를 즉시 파기합니다. 단, 관련 법령의 규정에 따라 보존할 필요가 있을 때에는 해당 법령에서 정한 바에 따라 보존합니다.
③ 이용자는 개인위치정보주체로부터 위 동의의 철회 요청을 받는 즉시 회사에게 해당 내용을 통보해야 합니다.
제 12조 (개인위치정보주체의 권리)
① 개인위치정보주체는 회사에 대하여 언제든지 개인위치정보를 이용한 위치기반서비스 제공 및 개인위치정보의 제 3자 제공에 대한 동의의 전부 또는 일부를 철회할 수 있습니다. 이 경우 회사는 수집한 개인위치정보 및 위치 정보 이용, 제공 사실 확인자료를 파기합니다.
② 개인위치정보주체는 회사에 대하여 언제든지 개인위치정보의 수집, 이용 또는 제공의 일시적인 중지를 요구할 수 있으며, 회사는 이를 거절할 수 없고 이를 위한 기술적 수단을 갖추고 있습니다.
③ 개인위치정보주체는 회사에 대하여 아래 각 호의 자료에 대한 열람 또는 고지를 요구할 수 있고, 당해 자료에 오류가 있는 경우에는 그 정정을 요구할 수 있습니다. 이 경우 회사는 정당한 사유 없이 해당 요구를 거절할 수 없습니다.
1) 본인에 대한 위치정보 수집, 이용, 제공 사실 확인자료
2) 본인의 개인위치정보가 위치정보의 보호 및 이용 등에 관한 법률 또는 따른 법률 규정에 의하여 제 3자에게 제공된 이유 및 내용
④ 개인위치정보주체는 제 1항 내지 제 3항의 권리행사를 위해 회사가 정한 소정의 절차를 갖추어 요구해야 합니다.
제 13조 (법정대리인의 권리)
① 회사는 14세 미만의 개인위치정보를 수집•이용•제공하고자 할 때(개인위치정보주체가 지정하는 제3자에게 제공하는 서비스를 하고자 하는 경우 포함)에는 14세 미만의 아동과 그 법정 대리인의 동의를 받아야 합니다. 이 경우 법정대리인은 본 약관에 의한 권리를 모두 가집니다.
② 회사는 14세 미만의 아동의 개인위치정보 또는 위치정보 이용, 제공 사실 확인자료를 이용약관에 명시 또는 고지한 범위를 넘어 이용하거나 제 3자에게 제공하고자 하는 경우에는 14세 미만의 아동과 그 법정대리인의 동의를 받아야 합니다. 단, 아래의 경우는 제외합니다.
1) 위치정보 및 위치기반서비스 제공에 따른 요금 정산을 위하여 위치정보 이용, 제공 사실 확인 자료가 필요한 경우
2) 통계 작성, 학술 연구 또는 시장조사를 위하여 특정 개인을 알아볼 수 없는 형태로 가공하여 제공하는 경우
...
1. 8세 이하의 아동
2. 금치산자
3. 장애복지법 제 2조 제 2항 제 2호의 규정에 의한 정신적 장애를 가진 자로서 장애인고용촉진 및 직업재활법 제2조 제2호의 규정에 의한 중증장애인에 해당하는 자(장애복지법 제32조의 규정에 의하여 장애인등록을 한 자에 한한다.)
...
제 15조 (이용자의 의무)
① 이용자는 서비스 이용에 따른 이용료를 지정된 날짜까지 내야 하며, 회사에게 알린 이용료 청구 주소와 연락처가 변경되었을 때에는 미리 해당 사실을 회사에게 통지해야 합니다.
② 이용자는 서비스 이용에 필요한 제반 정보를 제공하거나 등록할 때 현재의 사실과 일치하는 완전한 정보를 제공•등록하여야 하며, 변경사항이 발생하면 즉시 변경하고 통지해야 합니다.
③ 이용자는 회사가 위치정보를 수집하여 제공하는 서비스를 원활하게 이용하기 위하여 휴대전화 등 위치정보수집 단말장치가 정상적으로 작동하도록 관리해야 하며, 위치정보수집 단말장치가 정상적으로 작동하지 않아 회사의 개인위치정보 수집에 장애가 발생하면 해당 위치정보수집 단말장치를 수리하거나 교환하여 회사의 서비스 제공을 위한 위치정보 수집이 정상적으로 이루어지도록 합니다.
④ 이용자는 다음 각 호의 1에 해당하는 행위를 해서는 안 됩니다.
1. 개인위치정보 수집과 관련된 설비의 오동작이나 정보 등의 파괴 및 혼란을 유발하는 컴퓨터 바이러스 감염 자료를 등록하거나 유포하는 행위
2. 타인으로 가장하는 행위 및 타인과의 관계를 허위로 명시하는 행위
3. 자기 또는 타인에게 재산상의 이익을 주거나 타인에게 손해를 끼칠 목적으로 거짓된 정보를 유통하는 행위
...
② 위치정보관리책임자는 위치기반서비스를 제공하는 부사의 부서장으로서 구체적인 사항은 본 약관의 부칙에 따릅니다.
제 17조 (손해배상)
① 회사가 위치정보의 보호 및 이용 등에 관한 법률 제 15조 내지 제 26조의 규정을 위반한 행위로 이용자 또는 개인위치정보주체에게 손해가 발생한 경우 이용자 또는 개인위치정보주체는 회사에 대하여 손해배상 청구를 할 수 있습니다. 이 경우 회사는 고의, 과실이 없음을 입증하지 못하는 경우 책임을 면할 수 없습니다.
② 본 약관의 규정을 위반하여 회사에게 손해를 발생시킨 이용자는 회사에게 발생한 모든 손해를 배상해야 합니다. 이때 이용자는 고의, 과실이 없음을 입증하지 못하면 책임을 면할 수 없습니다.
③ 이용자가 본 약관의 규정을 위반하여 발생하는 개인위치정보주체를 비롯한 제3자의 이의제기, 분쟁, 소송 등 법률상 또는 사실상 제반 분쟁에 대한 모든 책임은 전적으로 이용자가 부담하며, 이용자는 그러한 분쟁과 관련하여 회사에게 발생하는 손해•손실을 배상하거나 보상해야 합니다.
제 18조 (면책)
① 회사는 다음 각 호의 경우로 서비스를 제공할 수 없는 경우 이로 인하여 이용자 또는 개인위치정보주체에게 발생한 손해에 대해서는 책임을 부담하지 않습니다.
...
② 회사가 이용자에게 제공한 위치정보와 기타 서비스의 이용에 따른 일체의 정보에 대한 관리책임은 이용자에게 있으며, 해당 정보의 관리소홀, 무단 또는 부정 사용 등에 대해 회사는 책임을 지지 않습니다.
③ 이용자가 서비스 및 서비스를 이용하여 얻은 정보에 대한 최종판단은 이용자가 직접 해야 하며, 회사는 이용자가 서비스 이용을 통해 기대하는 특정한 목적이나 수익에 대해 어떠한 보장도 하지 않습니다.
...
제 20조 (분쟁의 조정 및 기타)
① 회사는 위치정보와 관련된 분쟁에 대해 당사자간 협의가 이루어지지 아니하거나 협의를 할 수 없는 경우에는 위치정보의 보호 및 이용 등에 관한 법률 제28조 규정에 의한 방송통신위원회에 재정을 신청할 수 있습니다.
② 회사 또는 이용자 및 개인위치정보주체는 위치정보와 관련된 분쟁에 대해 당사자간 협의가 이루어지지 아니하거나 협의를 할 수 없는 경우에는 개인정보보호법 제40조의 규정에 의한 개인정보분쟁조정위원회에 조정을 신청할 수 있습니다.
제 21조 (회사의 연락처)
회사의 상호 및 주소 등은 다음과 같습니다.

1. 상 호 : 핀도 주식회사
2. 대 표 자 : 정범수
3. 주 소 : 서울특별시 강남구 강남대로 84길(역삼동)
4. 대표전화 : 1544-4885
부   칙
제1조 (시행일) 이 약관은 2019년 3월 8일부터 시행합니다.
